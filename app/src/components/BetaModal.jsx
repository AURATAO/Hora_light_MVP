...
export default function BetaModal() {
  ...
  return (
    <div className="fixed inset-0 z-9999 flex items-center justify-center bg-black/80 backdrop-blur-sm px-4">
      <div className="w-full max-w-lg rounded-2xl border border-white/10 bg-surface p-7 shadow-2xl">

        <h1 className="font-heading text-2xl text-white mb-4">
          You're in. Welcome to HO:RA Beta.
        </h1>

        <div className="space-y-3 text-sm text-white/70 font-secondary leading-relaxed mb-6">
          <p>
        ...
        <button
          ...
          className="w-full rounded-xl bg-brand py-3 text-sm font-secondary font-semibold text-white
